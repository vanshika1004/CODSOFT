                ...
                <div
                    ...
                    <div className="left">
                        <img
                            ...
                            src={'https://cdn1.iconfinder.com/data/icons/avatars-1-5/136/61-1024.png'} alt="profile"
                        />
                    </div>
                    <div className="right">
                        <h1
                        ...
                        <h2
                            style={{ color: mode === 'dark' ? 'white' : 'black' }} className="font-semibold">vishugupta@gmail.com
                        </h2>
                        <h2
                            style={{ color: mode === 'dark' ? 'white' : 'black' }} className="font-semibold">
                            <span>Total Blog : </span>  2
                        </h2>
