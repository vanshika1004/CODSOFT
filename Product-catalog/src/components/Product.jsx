...
const Product = ({post}) => {
  ...
  return (
    <div className='flex flex-col justify-between items-center hover:scale-110 transition duration-300 ease-in shadow-[0px_10px_1px_rgba(221,_221,_221,_1),_0_10px_20px_rgba(204,_204,_204,_1)] gap-3 p-4 mt-10 ml-5 rounded-xl'>
        <div>
